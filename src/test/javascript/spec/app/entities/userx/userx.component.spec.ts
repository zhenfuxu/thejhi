...
import { UserxComponent } from 'app/entities/userx/userx.component';
import { UserxService } from 'app/entities/userx/userx.service';
import { Userx } from 'app/shared/model/userx.model';

describe('Component Tests', () => {
  describe('Userx Management Component', () => {
    let comp: UserxComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(UserxComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.userxes[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
